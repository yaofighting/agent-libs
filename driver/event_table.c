...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_TCP_PACKET_ANALYSIS_E*/{"tcp_packet_analysis", EC_NET, EF_NONE_PARSE, 7, {{"tuple", PT_SOCKTUPLE, PF_NA}, {"ifindex", PT_UINT32, PF_DEC}, {"flag", PT_UINT16, PF_DEC}, {"seq", PT_UINT32, PF_DEC}, {"ack_seq", PT_UINT32, PF_DEC}, {"type", PT_UINT16, PF_DEC}, {"data_len", PT_UINT16, PF_DEC}}},
